...
test.describe('Contact API', () => {
  ...
  let personResponse: APIResponse;

  test.beforeAll(async ({ playwright }) => {
    await apiController.init();
    personResponse = await apiController.getUsers();
    const newUserTodo = await apiController.createUserTodo("Learning Playwright","in-progress");
